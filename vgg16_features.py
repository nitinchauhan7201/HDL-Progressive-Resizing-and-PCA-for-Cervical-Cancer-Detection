# -*- coding: utf-8 -*-
"""VGG16_Features.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1OlcR94FV5GSkqiNuO1A7eyxn-dMh1CJU
"""
...
model_vgg.fit_generator(generator=training_set_224, epochs=epochs, validation_data=validation_set_224, verbose=2)
model_vgg.save_weights("vgg_iteration1.h5")

"""EVALUATE PERFORMANCE ON THE TEST SET"""
y_test_224 = test_set_224.classes
pred_224 = np.argmax(model_vgg.predict(test_set_224, steps = None), axis=1)
...
opt = Adam(learning_rate=1e-4)
model_vgg.compile(optimizer=opt, loss='categorical_crossentropy', metrics=['acc'])
model_vgg.fit_generator(generator=training_set_512, epochs=epochs, validation_data=validation_set_512, verbose=2)
model_vgg.save_weights("vgg_iteration2.h5")

"""EVALUATE PERFORMANCE ON THE TEST SET"""
y_test_512 = test_set_512.classes
pred_512 = np.argmax(model_vgg.predict(test_set_512, steps = None), axis=1)
...
opt = Adam(learning_rate=1e-4)
model_vgg.compile(optimizer=opt, loss='categorical_crossentropy', metrics=['acc'])
model_vgg.fit_generator(generator=training_set_1024, epochs=epochs, validation_data=validation_set_512, verbose=2)
model_vgg.save_weights("vgg_iteration2.h5")

"""EVALUATE PERFORMANCE ON THE TEST SET"""
y_test_1024 = test_set_1024.classes
pred_1024 = np.argmax(model_vgg.predict(test_set_1024, steps = None), axis=1)
